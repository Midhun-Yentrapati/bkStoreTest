...
export class FilteredBooksComponent implements OnInit {
  ...
  currentFilterCategory: string | null = null;
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.pipe(
      switchMap(params => {
        ...
        this.currentFilterCategory = categoryFilter || null;

        // Always get all books and filter locally since getBooksByCategoryFiltered doesn't exist
  ...
  goToEditPage(bookId: string): void {
    this.router.navigate(['/edit-page', bookId]);
  }
