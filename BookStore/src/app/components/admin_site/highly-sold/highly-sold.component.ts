...
@Component({
  ...
  templateUrl: './highly-sold.component.html', // Point to external HTML
  styleUrls: ['./modern-chart.component.css']  // Point to external CSS
})
export class HighlySoldComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.fetchHighlySoldData();
  }

  fetchHighlySoldData(): void {
    this.isLoading = true;
